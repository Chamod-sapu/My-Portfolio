      ...
      >
        <div className="text-center">
          ...
          >
            <motion.a
              href="#projects"
              className="px-8 py-3 rounded-full bg-gradient-to-r from-primary-500 to-accent-500 text-white font-medium hover:shadow-lg hover:shadow-primary-500/50 transition-all duration-300"
            ...
            <motion.a
              href="#contact"
              className="px-8 py-3 rounded-full glass-effect text-gray-300 font-medium hover:border-primary-500 transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Contact Me
